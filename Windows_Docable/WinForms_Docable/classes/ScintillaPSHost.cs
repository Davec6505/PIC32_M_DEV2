...
namespace PIC32_M_DEV.classes
{
    internal sealed class ScintillaPSHost : PSHost
    {
        ...
        private sealed class ScintillaRawUI : PSHostRawUserInterface
        {
            ...
            public override void SetBufferContents(System.Management.Automation.Host.Rectangle rectangle, BufferCell fill) { /* no-op */ }
            public override void SetBufferContents(Coordinates origin, BufferCell[,] contents) { /* no-op */ }
